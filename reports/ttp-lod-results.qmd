...
load(here("data", "cleaned-data", "2024-02-13_TBTC-S29-clean.RData"))
load(here("data", "cleaned-data", "2024-02-13_TBTC-S29x-clean.RData"))
...
df_nc006_flow <- df_NC_006 %>% 
  dplyr::select(patient.id = USUBJID, MBDY, MBMETHOD, MBSTRESN, MBSTRESC, MBTSTDTL, COMMENT) %>% 
  distinct() %>% 
  ...
  mutate(weeks_rounded = floor(MBDY/7),
         dtp_42 = ifelse(MBSTRESC %in% c("NEGATIVE", paste0(">",42:48)), 42, MBSTRESN)) %>%
...
load(here("data", "model-generated", "2024-02-09_linear-nc002-lod-42.RData"))
load(here("data", "model-generated", "2024-02-09_linear-nc002-lod-30.RData"))
load(here("data", "model-generated", "2024-02-09_linear-nc002-lod-25.RData"))
```
