...
# load(here("data", "model-generated", "2023-08-24_linear-mams-lod-42_sensitivity.RData"))
# load(here("data", "model-generated", "2023-08-24_linear-mams-lod-30_sensitivity.RData"))
# load(here("data", "model-generated", "2023-08-24_linear-mams-lod-25_sensitivity.RData"))
# load(here("data", "model-generated", "2023-08-24_linear-remox-lod-42_sensitivity.RData"))
# load(here("data", "model-generated", "2023-08-24_linear-remox-lod-30_sensitivity.RData"))
# load(here("data", "model-generated", "2023-08-24_linear-remox-lod-25_sensitivity.RData"))
```
...
```{r}
coef_mams_25s <-
    brms::coef(m_linear_mams_25s, summary = F)$Treatm_arm %>% 
    as_tibble()
    
coef_mams_25s <-
    as_tibble(coef(m_linear_mams_25, summary = F)$Treatm_arm)
