...
p1 #+ coord_cartesian(xlim = c(10,20), ylim = c(10,20))
# library(ggExtra)
...
Overall correlation within replicates: `r round(cor(df_NC_002$rep1,df_NC_002$rep2), 4)`
...
m1 <- lm(log10(rep1) ~ log10(rep2), data = df_NC_002)
plot(m1)
```
