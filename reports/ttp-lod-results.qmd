...
Overall correlation within replicates: `r round(cor(df_nc_200_reps$rep1,df_nc_200_reps$rep2), 4)`
...
m1 <- lm(log10(rep1) ~ log10(rep2), data = df_nc_200_reps)
plot(m1)
```
