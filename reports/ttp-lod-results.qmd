...
load(here("data", "model-generated", "2024-02-16_linear-nc002-lod-42.RData"))
load(here("data", "model-generated", "2024-02-16_linear-nc002-lod-30.RData"))
load(here("data", "model-generated", "2024-02-16_linear-nc002-lod-25.RData"))
...
```{r}
#| eval: false
s1 <- summary(m_linear_mams_25, priors = TRUE)
s2 <- summary(m_linear_mams_30)
s3 <- summary(m_linear_mams_42)
bind_rows(s1$fixed, 
          s1$spec_pars,
          s2$fixed, 
          s2$spec_pars,
  ...
  mutate(Coefficient = case_when(str_detect(pattern = "Intercept", string = Coefficient) ~ "$\\gamma_0$",
                                 ...
                                 TRUE ~ "$\\sigma_1$")) %>% 
  kable(digits = c(2,2,2,2,2,3,1,1),
        format = "latex",
        booktabs = TRUE,
        escape = FALSE,
        caption = "MAMS-TB model results.") %>% 
  kable_styling() %>% 
